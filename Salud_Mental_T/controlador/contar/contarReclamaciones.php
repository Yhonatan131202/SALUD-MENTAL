...
$conexion = conectar();
function contarDatosReclamos($conexion) {
    // Verificar si la conexión se estableció correctamente
    if ($conexion) {
        // Realizar la consulta para contar los datos en la tabla
        $resultado = $conexion->query("SELECT COUNT(*) AS total FROM libro_reclamaciones");
...
// Uso de la función
$totalDatosReclamo = contarDatosReclamos($conexion);
?>
