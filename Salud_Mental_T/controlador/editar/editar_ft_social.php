...
if(isset($_POST['id_ft_social'])) {
    // Obtener el ID del psicólogo a actualizar
    $Id_Director = $_POST['id_ft_social'];
    ...
    if ($_FILES['Nueva_Foto']['error'] === UPLOAD_ERR_OK) {
        ...
        $sql = "UPDATE ft_social_csmc SET foto='$Foto', nombre = '$Servidor_Social', profesion ='$Profesion', Gmail ='$Gmail', telefono = '$Telefono', descripcion = '$Descripcion' WHERE id_ft_social = '$Id_Director'";
    } else {
        // Si no se proporciona una nueva imagen, mantener la imagen existente
        $sql = "UPDATE ft_social_csmc SET nombre = '$Servidor_Social', profesion ='$Profesion', Gmail ='$Gmail', telefono = '$Telefono', descripcion = '$Descripcion' WHERE id_ft_social = '$Id_Director'";
    }
