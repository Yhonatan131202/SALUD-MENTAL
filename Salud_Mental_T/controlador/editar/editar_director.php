...
if(isset($_POST['id_director'])) {
    ...
    if ($_FILES['Nueva_Foto']['error'] === UPLOAD_ERR_OK) {
        ...
        $sql = "UPDATE director_csmc SET foto='$Foto', nombre = '$Servidor_Social', profesion ='$Profesion', Gmail ='$Gmail', telefono = '$Telefono', descripcion = '$Descripcion' WHERE id_director = '$Id_Director'";
    } else {
        // Si no se proporciona una nueva imagen, mantener la imagen existente
        $sql = "UPDATE director_csmc SET nombre = '$Servidor_Social', profesion ='$Profesion', Gmail ='$Gmail', telefono = '$Telefono', descripcion = '$Descripcion' WHERE id_director = '$Id_Director'";
    }
