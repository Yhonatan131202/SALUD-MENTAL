<?php
    ...
    if(isset($_FILES['foto3']) && $_FILES['foto3']['error'] === UPLOAD_ERR_OK) {
        // Obtener la imagen
        $Foto = addslashes(file_get_contents($_FILES['foto3']['tmp_name']));
    } else {
    ...
    $sql = "INSERT INTO ft_social_csmc (foto, nombre, profesion, Gmail, telefono, descripcion) VALUES ('$Foto','$Servidor_Social','$Profesion','$Gmail','$Telefono','$Descripcion')";
